...
| ArithExpr.unOp ArithUnOp.fac (e : ArithExpr) , i => factorial (arithEval e i)
| ArithExpr.binOp ArithBinOp.add  (e1 : ArithExpr) (e2 : ArithExpr), i => (arithEval e1 i) + (arithEval e2 i)
| ArithExpr.binOp ArithBinOp.sub (e1 : ArithExpr) (e2 : ArithExpr), i => (arithEval e1 i) - (arithEval e2 i)
| ArithExpr.binOp ArithBinOp.mul (e1 : ArithExpr) (e2 : ArithExpr), i => (arithEval e1 i) * (arithEval e2 i)

-- | ArithExpr.unOp (op : ArithUnOp) (e : ArithExpr), i=> (evalUnOp op) (arithEval e i)
-- | ArithExpr.binOp (op : ArithBinOp) (e1 : ArithExpr) (e2 : ArithExpr),  i => (evalBinOp op) (arithEval e1 i) (arithEval e2 i)
...
#eval arithEval (Y - [1]) interp_1  -- expect 2
