...
/-
You answers here:
The interpretation 1,1 means "It's raining and it's sprinkling." This is a c-ex because 
the or statement is true and IsRaining is true but Not(IsSprinkling) is false.
-/
...
/-
The interpretation 1,0 means "It's raining and it's not sprinkling." This is a c-ex because 
the first if-then is vacuously true and "¬isSprinkling" is true, but "¬isRaining" is false.
-/
def cxs3 : List BoolInterp := findCounterexamples affirm_consequent
#eval! interpStringsFromInterps cxs3 2
/-
The interpretation 1,0 means "It's raining and it's not sprinkling." This is a c-ex because 
the first if-then is vacuously true and "isRaining" is true, but "isSprinkling" is false.
-/
